...
<body>
	...
	<form action="<%=request.getContextPath()%>/adminTodayInsert.to" method="post" enctype="multipart/form-data">
	<input type="hidden" name="boardWriter" value="<%=loginUser.getMemberNo() %>">
		<div class="outer">
	        ...
	        <div id="r3">
	            ...
	            <div id="r31">이벤트 일자 : <input type="date" name="boardDate"></div>
            ...
            <div id="r6">
                <div class="rbtng" align="center">
                    ...
                    <button class="rbtn" id="save">등록</button>
                </div>
            </div>
