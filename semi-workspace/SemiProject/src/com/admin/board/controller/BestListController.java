 ...
 */
@WebServlet("/adminBestList.bo")
public class BestListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		categoryCode = categoryCode==null?"VIEWS":categoryCode;
		int currentPage = cPage == null ? 1 : Integer.parseInt(cPage);
		int listCount = new BoardService().countBest();

		PageInfo pageInfo = new PageInfo(listCount, currentPage);

		ArrayList<Board> list = new BoardService().selectBestList(pageInfo,categoryCode);
