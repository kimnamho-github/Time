...
<body>
    ...
    <div class="outer">
        <div id="content">
            ...
            <div id="content2">
                <br>
                <h1 align="center" style="margin: initial;">전체 게시판</h1>
                <br>
                <div class="search-area" style="margin-top: 20px;">
                    ...
                    <button class="btn btn-primary" id="todayInsertBtn" onclick="location.href='<%= request.getContextPath() %>/adminTodayEnrollView.to'" style="display:none; width: 10%; float: right; margin-right: 10px;">추가</button>
                    <button class="btn btn-primary" id="infoInsertBtn" onclick="location.href='<%= request.getContextPath() %>enrollForm.in'" style="display:none; width: 10%; float: right; margin-right: 10px;">추가</button>
                    ...
                    <select name="boardCode" id="boardCode" class="form-select" style="width: 20%; float: right; margin-right: 10px;">
                        <% if(btList!=null){ %>                                
                        	<option value="%">전체 게시판</option>
                            <% for(BoardType btEl : btList){ %>
                                <option value="<%= btEl.getBoardCode() %>"><%= btEl.getBoardKorName() %></option>
                            <% } %>
                        <% } %>
                    </select>     
                </div>
    ...
    <script>
        <%@ include file="../../../resources/js/adminBoard.js" %>
    </script>
