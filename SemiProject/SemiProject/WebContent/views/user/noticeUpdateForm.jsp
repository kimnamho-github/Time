...
<body>
	...
	<div class="outer1">
		<div id="list1">
			<h2 id="ntu">
				<img src="resources/image/common/pencil.png" id="r-logo">공지사항 수정 </h2>
		</div>
		<form action="<%=request.getContextPath()%>/update.in" method="get"
			id="enroll-form">
			<input type="hidden" name="nno" value="<%=n.getBoardNo()%>">
			<div class="en">
				<table aling="center">
					<tr>
						<th width="50" id="tii">제목</th>
						<td width="650"><input type="text" name="title" id="t1"
							required value="<%=n.getBoardTitle()%>"></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2"><textarea name="content" rows="22"
								...
								placeholder="수정하실 내용을 입력해주세요." maxlength="700"><%=n.getBoardContent()%></textarea>
						</td>
					</tr>
				</table>
			</div>
			<div align="center" class="rbtng">
				...
				<button type="submit" class="rbtn" id="save" onclick="textArea();">수정</button>
			</div>
		</form>
	</div>
