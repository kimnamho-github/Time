...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resources/css/board/boardWrite.css">
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resources/css/asiana/reset.css">
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resources/css/header.css">
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resources/css/mypage/mypageHeader.css">
<link href="/src/main/webapp/resources/css/header.css" rel="stylesheet">
<link href="/src/main/webapp/resources/css/mypage/mypageHeader.css" rel="stylesheet">
 <!-- summerNote -->
...
<form action="${pageContext.request.contextPath}/insert.bo" method="post" enctype="multipart/form-data" id = "frm">
<table class="table_form">
	...
	<tr>
		...
		<td>
			<input type="text" name="boardTitle" id="title" class="full common textWrite" style="100%;">
			<input type="hidden" id="writer" name="writer" value = "${loginUser.userId}">
		</td>	
	</tr>
	...
	<tr>
		...
		<td>
			<select id="cate" name="categoryNo" class=" cate common textWrite">
				<option>선택하세요</option>
				<option value = 10>CarrotLine소식</option>
				<option value = 20>CarrotLine클럽</option>
				<option value = 30>유류할증료</option>	
				<option value = 40>제휴사소식</option>
	...
	<tr>
		...
		<td>
			<div class="textarea_wrap">
				...
				<textarea name="boardContent" class="common textWrite summernote" id="contents" rows="4" cols="50" style="position: relative;"></textarea>	
		...
		<th scope="row">
			...
			<td>
				<div class="jfile_wrap">
						<input type="file" title="파일첨부" class = "addfile" id="attfile1" name="upfile">
...
<input type="hidden" id="ihidden" name="boardContent">
