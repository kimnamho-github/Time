						...
						<div class="login_wrap">
							...
							<div class="inner" id="logindiv">
								...
								<div class="input_wrap">
									<input type="text" id="userId" name="userId" placeholder="아이디 입력" title="아이디 입력" style="width:500px;"> 
									<input type="password" id="userPwd" name="userPwd" placeholder="비밀번호 입력" title="비밀번호 입력" style="width:500px;" autocomplete="off" onkeyup="enterkey();"> 
								</div>
...
$("#login_check_area input").click(function(){
	if($(this).attr('id') == "loginType_ID"){
		$("#userId").prop('title', '아이디 입력');
		$("#userId").prop('placeholder', '아이디 입력');
		$("#labelSaveID").text('아이디 저장');
		$("#userId").attr('maxlength', 100);
	}else{
		$("#userId").prop('title', '회원번호 입력');
		$("#userId").prop('placeholder', '회원번호 입력');
		$("#userId").attr('maxlength', 11);
