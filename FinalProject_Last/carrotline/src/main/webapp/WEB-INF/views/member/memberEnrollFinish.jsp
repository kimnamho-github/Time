...
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/newni/qrcode.js"></script>
</head>
<body>
...
<div class="container" id="container">
		<div class="mem_wrap">
			...
			<p class="text_type10">캐럿라인 회원에게 드리는 다양한 혜택을 누려보세요.</p> 
				...
				<div class="left">
					...
					<table class="table_list">
						...
						<tbody>
							<tr>
								<th scope="row">이메일</th> 
								<td class="taL">${loginUser.email}</td>
							</tr>
							<tr>
								<th scope="row">아이디</th> 
								<td class="taL">${loginUser.userId}</td>
							</tr>			
						</tbody>
					</table>
<!-- 					<p class="btn_end_wrap">
			...
			<div class="btn_wrap_ceType1">
				<button type="button" class="btn_L white" id="btn_main" onclick="location.href='../'">캐럿라인 메인</button> 
				...
				<ul>
					<li>
						...
						<div class="txt_wrap">
							<dl>
								<dt>마일리지 적립 및 사용</dt> 
								<dd>캐럿라인클럽은 캐럿라인의 사용우대 프로그램으로 '캐럿라인클럽 마일리지'를 기반으로 운영됩니다. <br>캐럿라인클럽 회원님께서는 캐럿라인 항공 및 제휴사를 이용하실 때마다 마일리지를 적립하실 수 있으며 적립된 마일리지로 마일리지 항공권 이용 <br>등이 가능하십니다.</dd> 
							</dl>				
						</div>
					</li>
					<li class="col2">
						<ul>
							<li>
								...
								<div class="txt_wrap">
									<dl>
										<dt>캐럿라인항공 뉴스레터</dt> 
										<dd>뉴스레터를 통해, 마일리지 실적 및 캐럿라인의 <br>다양한 혜택을 이메일로 받아 보실 수 있습니다.</dd> 
									</dl>
								</div>
							</li>
							<li>
								...
								<div class="txt_wrap">
									<dl>
										<dt>회원전용 이벤트 참여하기</dt> 
										<dd>캐럿라인 웹사이트에서 진행하는 다양한 이벤트에 <br>참여하실 수 있습니다.</dd> 
									</dl>					
								</div>
							</li>
						</ul>
