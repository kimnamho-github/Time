...
<%--  <c:import url="/src/main/webapp/template/boot.jsp"></c:import> --%>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">CARROT LINE 매출 현황</h1>
          </div>
              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-m font-weight-bold text-danger text-uppercase mb-1">이달의 항공권 판매량 (${yearMonth})</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                      <fmt:setLocale value="ko_KR"/><fmt:formatNumber type="currency" value="${monthSalesCount}" currencySymbol="￦"/>
                      </div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-m font-weight-bold text-success text-uppercase mb-1">오늘의 항공권 판매량 (${now})</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                      <fmt:setLocale value="ko_KR"/><fmt:formatNumber type="currency" value="${todaySalesCount}" currencySymbol="￦"/></div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-won-sign fa-2x text-gray-300"></i>
                    </div>
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <c:choose>
                          	<c:when test= "${not empty salesRate}">
                          		<div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">${salesRate}%</div>
                          	</c:when>
                          	<c:when test= "${not empty todaySche}">
                          		<div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">${todaySche}</div>
                          	</c:when>                     	
                          </c:choose>
                        </div>
                        <div class="col">
